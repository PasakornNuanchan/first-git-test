...
<body class="  ">
    ...
    <!-- loader END -->
    <?php
        include('include/sidebarmain.php');
    ?>
                        ...
                        <div class="overflow-hidden d-slider1">
                            <ul class="p-0 m-0 mb-2 swiper-wrapper list-inline">
                                <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                                    <div class="card-body">
                                        <div><a href="https://github.com/PasakornNuanchan/first-git-test" target="_Blank">Git</a></div>
                                    </div>
                                </li>
                                <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                                    <div class="card-body">
                                        ...
                                        <div><a href="https://www.google.co.th" target="_Blank">Google</a></div>
                                    </div>
                                </li>
                                <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                                    <div class="card-body">
